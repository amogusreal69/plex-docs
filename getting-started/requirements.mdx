...
<Tabs>
  <Tab title="Windows Dependencies" icon="grid-2x2">
    ...
    <Steps>
      <Step title="Install Visual Studio Desktop Development C++" titleSize="h3">
      ...
      <Step title="Install Node.js LTS" titleSize="h3">
      ...
      <Step title="Install Build Tools" titleSize="h3">
      ...
      <Step title="Verify Installation" titleSize="h3">
