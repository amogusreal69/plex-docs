...
<Steps>
    <Step title="Download the Bot" titleSize="h3">
    ...
    <Step title="Modify the config file" titleSize="h3">
    ...
    <Step title="Install Node.js Modules" titleSize="h3">
    ...
    <Step title="Start the Bot" titleSize="h3">
